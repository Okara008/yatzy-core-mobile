	...
	return (<>
		...
		<View style={styles.header}>
			<View style={styles.playerScores}>
				<Text style={[styles.name, {color: 'yellow'}]} numberOfLines={2} ellipsizeMode='2ail'>
					{playerNames.p1 ? playerNames.p1:  'Square'}
				</Text>
				<Text style={[styles.score, {color: 'yellow'}]}>{score1}</Text>
			</View>
			...
			<View style={styles.playerScores}>
				...
				<Text style={[styles.score, {color: 'springgreen'}]}>{score2}</Text>
			</View>
		</View>
	</>)
}
